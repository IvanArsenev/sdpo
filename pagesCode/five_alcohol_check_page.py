...
class alcohol_check_page(object):
	def setupUi(self, Form):
		...
		self.text.setGeometry(QtCore.QRect(30, 30, 451, 41))
		font = QtGui.QFont()
		font.setFamily("Inter")
		...
		self.text2.setGeometry(QtCore.QRect(201, 293, 401, 31))
		font = QtGui.QFont()
		font.setFamily("Inter")
		...
		self.image.setText("")
		icon = QtGui.QIcon()
		icon.addPixmap(QtGui.QPixmap("D:/Work/SDPO/design/img/alco.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
	...
	def retranslateUi(self, Form):
		...
		self.step_text.setText(_translate("Form", "3/5"))
		self.text.setText(_translate("Form", "Измерение уровня алкоголя"))
		self.text2.setText(_translate("Form", "Сделайте выдох в трубку до щелчка..."))
